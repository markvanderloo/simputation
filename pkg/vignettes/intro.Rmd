...
This package offers a number of commonly used imputation methods, each with a similar and hopefully simple interfae. At the moment the following imputation methodology
is supported.
